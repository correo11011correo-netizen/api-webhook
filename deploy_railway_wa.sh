#!/bin/bash
# Script para crear una rama de producción para Railway y subirla a GitHub (WhatsApp Platform)

echo "🚀 Iniciando subida de configuración para Railway (WhatsApp Platform)..."

# 1. Configuración de Credenciales
# Nota: En un entorno real, estas variables deberían estar en un .env o secret manager
TOKEN="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"
USER="software-0ficial"
REPO_URL="https://github.com/software-0ficial/plataforma-whatsapp.git"
...
git remote add origin "https://$USER:$TOKEN@github.com/software-0ficial/plataforma-whatsapp.git"
